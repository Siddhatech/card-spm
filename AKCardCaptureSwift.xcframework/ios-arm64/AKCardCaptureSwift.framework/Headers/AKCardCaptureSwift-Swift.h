...
#ifndef AKCARDCAPTURESWIFT_SWIFT_H
#define AKCARDCAPTURESWIFT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AKCardCaptureSwift",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)
@class CardCaptureCustomization;
...
@property (nonatomic, strong) UIFont * _Nullable customHeaderFont SWIFT_DEPRECATED_MSG("This property will be removed soon, use titleFont instead", "titleFont");
@property (nonatomic, strong) UIFont * _Nullable titleFont;
@property (nonatomic, strong) UIFont * _Nullable customFont SWIFT_DEPRECATED_MSG("This property will be removed soon, use textFont instead", "textFont");
